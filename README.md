...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code\&size=20\&duration=3000\&pause=800\&color=58A6FF\&center=true\&vCenter=true\&width=750\&lines=🤖+ROS+2+Developer;🌐+IoT+Engineer;🧠+AI+for+Robotics;🚀+Building+Autonomous+Systems;📍+ENIAD+Berkane+%7C+ROC+Engineering+Student)](https://git.io/typing-svg)
...
I aim to become a Robotics Software Engineer specialized in:
...
**Tech Stack:** YOLOv8 • OpenCV • MQTT • Raspberry Pi 5
...
| ----------------------- | -------------------------------------- |
| 🐢 turtle_navigation    | PID, FSM and APF Navigation Algorithms |
| 📚 ros2_yehia_learning  | Complete ROS 2 Learning Repository     |
| 🔥 FireBot              | AI-Based Fire Detection Robot          |
| 🌐 SmartSound Monitor   | ESP32 IoT Monitoring Platform          |
...
* 🚀 Developing an Autonomous Mobile Robot using Nav2 and SLAM.
...
[LinkedIn](https://www.linkedin.com/in/yahya-elkhoulati-535580331/) •
[GitHub](https://github.com/YehiaElkh) •
Email: [yahyaelkhoulati@ump.ac.ma](mailto:yahyaelkhoulati@ump.ac.ma)
...
⚡ I enjoy building robotic systems from scratch.

📚 I document my projects professionally.

🚀 My goal is to contribute to the future of Autonomous Robotics.
